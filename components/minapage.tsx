            ...
            <main className="flex-1 px-4 md:px-6">
                <section>
                    <div className="h-[400px] flex items-center">
                        <div className=" ">
                            ...
                            <h1 className="font-bold text-5xl">Empfip Wool Dryer Balls</h1>
                            <p className="mt-3">Make your laundry softer, reduce drying time, and save money with our eco-friendly wool dryer balls.</p>
                        </div>
                    </div>
                </section>
                <section className="h-[400px]">
                    <div>
                        <div className="flex">
                            <svg
                                className="w-8 h-auto fill-zinc-900 dark:fill-zinc-50 md:w-10 max-lg:self-end bg-amber-300"
                                viewBox="0 0 35 36"
                            ...
                            <svg
                                className="w-11 h-auto fill-zinc-900 dark:fill-zinc-50 md:w-13 max-lg:self-start "
                                viewBox="0 0 30 31"
                                xmlns="http://www.w3.org/2000/svg"
                            >
                                <path
                        ...
                        <p className="text-gray-500 dark:text-gray-400">Discover the benefits of our wool dryer balls. Eco-friendly, cost-effective, and perfect for every load.</p>
                    </div>
                ...
                <section id="benefits" className="w-full py-12 md:py-24 lg:py-32 bg-paleSand dark:bg-gray-800">
                ...
                <section id="buy-now" className="w-full py-12 md:py-24 lg:py-32 bg-gray-100 dark:bg-gray-800">
                    <div className="container px-4 md:px-6">
